...
class EmbeddingNet(nn.Module):
    def __init__(self, n_channels = 3, D = 16, bilinear=False, nearest=False):
        ...
        self.up1 = Up(1024, 512, bilinear, nearest)
        self.F1 = OutConv(512, D)
        self.up2 = Up(512, 256, bilinear, nearest)
        self.F2 = OutConv(256, D)
        self.up3 = Up(256, 128, bilinear, nearest)
        self.F3 = OutConv(128, D)
        # self.up4 = Up(64, 32 * factor, bilinear) # gives output features
        self.up4 = Up(128, 64, bilinear, nearest) # gives output features
