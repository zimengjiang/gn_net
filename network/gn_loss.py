...
class GNLoss(nn.Module):
    ...
    GN loss function.
    '''
    def __init__(self, margin = 1.0, lamda = 0.003, img_scale = 4):
    ...
    def forward(self, F_a, F_b, known_matches):
        ...
        fa_4_sliced = self.extract_features(F_a[-1], known_matches['a']/self.img_scale) # //4 if the input image is scaled
