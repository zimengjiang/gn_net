...
# select the hardest negative correspondence
def hard_select_negative_matches(matches_in_1, matches_in_2, num_of_pairs=1024):
    ...
    for index1 in random_index:
        ...
        # print(index)
        for index2 in range(matches_in_2.shape[0]):
    ...
    matches_in_2_random_selected = [matches_in_2[index2] for index2 in neg_best_index2_list]
